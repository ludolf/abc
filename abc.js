...
table.set('7', '00000110')
table.set('8', '00000111')
table.set('9', '00001000')
table.set('A', '00001001')
table.set('B', '00001010')
table.set('C', '00001011')
table.set('D', '00001100')
table.set('E', '00001101')
table.set('F', '00001110')
table.set('G', '00001111')
table.set('H', '00010000')
table.set('I', '00010001')
table.set('J', '00010010')
table.set('K', '00010011')
table.set('L', '00010100')
table.set('M', '00010101')
table.set('N', '00010110')
table.set('O', '00010111')
table.set('P', '00011000')
table.set('Q', '00011001')
table.set('R', '00011010')
table.set('S', '00011011')
table.set('T', '00011100')
table.set('U', '00011101')
table.set('V', '00011110')
table.set('W', '00011111')
table.set('X', '00100000')
table.set('Y', '00100001')
table.set('Z', '00100010')
